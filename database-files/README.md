# CoopTrack Database Initialization
...
From the CoopTrack repository root, rebuild the database with:
...
CoopTrack loads `01_schema.sql` first and `02_sample_data.sql` second. A clean
initialization creates 18 tables and 1,288 demonstration rows.
